...
-- targeted_word_index:    A 0-based index that specifies the word targeted within this statement. 
...
-- parent_id: Id of the footnote where the statement is made
CREATE TABLE `footnote_statement_link`(
	`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, 
	`parent_id` INT NOT NULL, 
	CONSTRAINT fsl_f_parent_ref_fk FOREIGN KEY fsl_f_parent_ref_idx (parent_id) REFERENCES `footnote`(`id`) ON DELETE CASCADE
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
